...
locals {
  customers = [
    { name = "AcmeCorp", enable_batch = false, enable_realtime = true, datacenter = "dc/frankfurt" },
    { name = "BetaInc", enable_batch = false, enable_realtime = true, datacenter = "dc/virginia" }
  ]
}
